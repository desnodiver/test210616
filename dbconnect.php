<?php
	...
	mysql_query ("CREATE TABLE IF NOT EXISTS gb (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, username VARCHAR (100), dt DATETIME, mail VARCHAR (30), msg TEXT)") or die ("Не могу создать таблицу gb.");
?>